...
anomaly detector in Scala.

## 🚀 Overview
This repository contains a professional implementation of **Scala Anomaly Detector**. It is designed with clean code principles and focuses on functionality and reliability.
